...
The energy/product estimates in `work/pass3/quantitative-core-stage.md` apply to arbitrary smooth divergence-free data, not only its earlier rotating-core example. Reuse their explicit constants:
