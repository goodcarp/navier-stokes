...
**Latest:** [The twelfth-pass report](pass12/REPORT.md) derives an H4-compatible solution-adapted core estimate, repairs a specific gradient passage in the parallel Claude argument, and implements compact H7 potential endpoint reconstruction. Continuous-form checks expose and reject a misleading sampled fit; the corrected continuous L2 fit remains an unvalidated approximation. Whole-slab residual control, useful actual gains, and inherited return are still open; [STATUS.md](STATUS.md) records the current state.
